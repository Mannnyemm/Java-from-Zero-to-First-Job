...
import com.manny.oop.exams.onlineshop.enteties.impl.DefaultProduct;
...
public class DefaultProductManagementService implements ProductManagementService {
	...
	private static void initProducts() {
		products = new Product[] {
				...
				new DefaultProduct(5, "Worcester 2000 30kW Ng Combi Boiler Includes Free Comfort+ II controller", "Boilers",
						989.99),
				...
				new DefaultProduct(8, "Wienerberger Terca Class B Engineering Brick Red 215mm x 102.5mm x 65mm (Pack of 504)",
						"Bricks", 402.99),
				new DefaultProduct(9, "Wienerberger Terca Engineering Brick Blue Perforated Class B 65mm (Pack of 400)", "Bricks",
						659.99),
