package com.manny.javacollections.iteratorexample;
...
// 		<write your code here
        ...
        /** 
         * Index of last element returned by Iterator,
         * == -1 when hasNext method has not been called or remove method has just been called
         */
        int lastReturnedIndex = -1;
        
        /**
         * Checks if list has other elements after cursor
         * @return boolean true if list has other elements after, else false
         */
		 ...
		 * @returns Object next element in iterator
		 */
		public Object next(){
		...
		/**
		 * Removes last returned element by iterator
		 * @throws IllegalStateException if next method has not 
		 * not been called
		 */
		public void remove(){
		    ...
		    removeNodeByIndex(lastReturnedIndex);
		    lastReturnedIndex = -1;
		}
