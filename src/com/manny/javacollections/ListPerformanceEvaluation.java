...
public class ListPerformanceEvaluation {
	...
	/**
	 * Adds a specified amount of elements to a given list
	 * @param list List to add elements to
	 * @param amountOfElements Integer - amount of elements to add to list
	 */
	...
	/**
	 * Adds a specified amount of elements to the beginning of a given list
	 * @param list List to add elements to
	 * @param numberOfElementsToAdd Integer - amount of elements to add to list
	 */
...
//		<write your code here>
	...
	/**
	 * Adds a specified amount of elements to the middle of a given list
	 * @param list List to add elements to
	 * @param numberOfElementsToAdd Integer - amount of elements to add to list
	 */
...
//			<write your code here>
	...
	/**
	 * Adds a specified amount of elements to the end of a given list
	 * @param list List to add elements to
	 * @param numberOfElementsToAdd Integer - amount of elements to add to list
	 */
...
//			<write your code here>
	...
	/**
	 * Removes a specified amount of elements from the beginning of a given list
	 * @param list List to remove elements to
	 * @param numberOfElementsToRemove Integer - amount of elements to remove from list
	 */
...
//		<write your code here>
	...
	/**
	 * Removes a specified amount of elements from the middle of a given list
	 * @param list List to remove elements to
	 * @param numberOfElementsToRemove Integer - amount of elements to remove from list
	 */
...
//			<write your code here>
	...
	/**
	 * Removes a specified amount of elements from the end of a given list
	 * @param list List to remove elements to
	 * @param numberOfElementsToRemove Integer - amount of elements to remove from list
	 */
